...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <form method="POST" action="<?= $base ?>/insta-create">
            <div class="row">
                <div class="col-lg">
                    <div class="card">
                                ...
                                <div class="form-row">
                                    <div class="col-lg">
                                        <div class="form-label-group">
                                            <label for="nome">Username do Instagram</label>
        ...
        <div class="row">
            <div class="col-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3>Relatório de Usuários do Instagram
                                ...
                                <?php foreach ($data as $dt) : ?>
                                    <?php if ($authenticated || $_SESSION['logou'] == $dt['login']): ?>
                                        <tr>
                                            ...
                                            <td>@<?= $dt['username']; ?></td>
                                            <td>
                                                <a href="<?= $base; ?>/insta-update/<?= $dt['id']; ?>"
                                                   class="btn btn-primary" data-toggle="tooltip"
                                                   title="Editar username"><i class="fa fa-edit"></i></a>
                                                <a href="<?= $base ?>/insta-delete/<?= $dt['id'] ?>"
